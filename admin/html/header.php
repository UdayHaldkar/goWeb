    ...
    <div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-left">
                    <div class="navbar-btn">
                        <a href="index.php"><img src="assets/images/favicon.png" alt="goWeb Logo"
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="p_social"><a href="page-social.php" class="social icon-menu" title="News">Social</a>
                        </li>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ml-3">
                                        <a href="page-invoices-detail.php" title="">South Shyanne</a>
                ...
                <div class="row clearfix">
                    <div class="col-12">
                        <ul class="q_links">
                            ...
                            <li><a href="app-chat.php"><i class="icon-bubbles"></i><span>Messenger</span></a></li>
                            <li><a href="app-calendar.php"><i class="icon-calendar"></i><span>Event</span></a></li>
                            <li><a href="page-profile.php"><i class="icon-user"></i><span>Profile</span></a></li>
                            <li><a href="page-invoices.php"><i class="icon-printer"></i><span>Invoice</span></a></li>
                            <li><a href="page-timeline.php"><i class="icon-list"></i><span>Timeline</span></a></li>
                        </ul>
                    </div>
        ...
        <div id="left-sidebar" class="sidebar">
            <div class="navbar-brand">
                <a href="index.php"><img src="../assets/images/icon.svg" alt="goWeb Logo"
                        class="img-fluid logo"><span><b style="color:#00A0D0">go</b>Web</span></a>
            ...
            <div class="sidebar-scroll">
                <div class="user-account">
                    ...
                    <div class="dropdown">
                        ...
                        <a href="javascript:void(0);" class="dropdown-toggle user-name"
                            data-toggle="dropdown"><strong>Sourabh Vinodiya</strong></a>
                ...
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu">
                        ...
                        <li>
                            <a href="#myPage" class="has-arrow"><i class="icon-pencil"></i><span>Documents</span></a>
                            <ul>
                                <li><a href="forms-summernote.php">Create</a></li>

                                <li><a href="forms-dragdropupload.php">Upload</a></li>
                                 <li><a href="#">Download</a></li>
                                  <li><a href="#">View</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#" class="has-arrow"><i class="icon-docs"></i><span>Storage</span></a>
                            <ul>
                        ...
                        <li><a href="app-contact.php"><i class="icon-list"></i><span>Contact list</span></a></li>


                        </li>
                        <li><a href="app-inbox.php"><i class="icon-envelope"></i><span>Email</span></a></li>
                        <li><a href="app-chat.php"><i class="icon-bubbles"></i><span>Messenger</span></a></li>


                        <li><a href="app-todo.php"><i class="icon-layers"></i><span>To-Do list</span></a></li>


                        <li><a href="app-calendar.php"><i class="icon-calendar"></i><span>Calendar</span></a></li>
                        <li><a href="forms-summernote.php"><i class="icon-list"> </i><span>Notes</span></a></li>
